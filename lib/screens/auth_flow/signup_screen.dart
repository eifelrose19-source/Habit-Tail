...
class _GoldBalancesSheet extends ConsumerWidget {
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        const SizedBox(width: AppTheme.spacingM),
                        GestureDetector(
                          onTap: () => _confirmReset(context, ref, child),
                          child: Container(
                            padding: const EdgeInsets.symmetric(
  ...
  void _confirmReset(BuildContext context, WidgetRef ref, UserModel child) {
    showDialog(
      context: context,
      builder: (_) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            ...
            child: Text('Reset',
                style: AppTheme.buttonText(color: AppTheme.statusRejected)),
          ),
        ],
      ),
    );
  ...
  Widget _toggleRow(String label, bool value, ValueChanged<bool> onChanged) {
    return Container(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          Expanded( // ← fixes the 42px overflow
